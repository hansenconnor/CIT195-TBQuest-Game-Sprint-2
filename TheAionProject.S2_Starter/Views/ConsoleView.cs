...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public int DisplayGetNextSpaceTimeLocation()
        {
            ...
            DisplayGamePlayScreen("Travel to a nNew Space-Time Location", Text.Travel(_gameTraveler, _gameUniverse.SpaceTimeLocations),ActionMenu.MainMenu, "");
            ...
            while ( !validSpaceTimeLocationId  )
            {
                ...
                //
                GetInteger($"Enter your new location {_gameTraveler.Name}: ", 1,
                    _gameUniverse.GetMaxSpaceTimeLocationId(), out spaceTimelocationId);
